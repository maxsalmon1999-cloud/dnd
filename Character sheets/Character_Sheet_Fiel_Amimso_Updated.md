...
🎵 Combat Actions
Shortbow (reinforced) — +5 to hit
1d6 + 3 piercing, range 80/320 ft
Dagger (sharpened) — +5 to hit
1d4 + 3 piercing, finesse, thrown 20/60 ft

🗡 Sneak Attack
+2d6 damage (once per turn)
Triggers: advantage on attack OR ally within 5 ft of target
Requires: finesse or ranged weapon

🎒 Key Equipment
Reinforced Shortbow (Lars' gift)
Sharpened Dagger (Lars' gift)
6 Steel-Tipped Arrows (Lars' gift)
Thieves' Tools
Ball Bearings
...
Can hide behind a creature one size larger
