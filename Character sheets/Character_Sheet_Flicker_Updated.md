...
🎵 Combat Actions
Eldritch Blast (Agonizing Blast) — +5 to hit
1d10 + 3 force, range 120 ft
Reinforced Dagger (Lars' gift) — +4 to hit
1d4 + 2 piercing, finesse, thrown 20/60 ft

🎒 Key Equipment
Studded Leather Armor
Reinforced Dagger (Lars' gift)
Iron-Shod Arcane Focus Case (Lars' gift)
Arcane Focus (Tome)
Shortbow (scavenged goblin)
Scimitar (scavenged goblin)

🎼 Spell Slots
Warlock Slots: 2 (2nd level)
...
Mask of Many Faces
Cast Disguise Self at will (no spell slot)

📖 Pact Boon — Pact of the Tome
Grants 3 extra cantrips from any class (Guidance, Minor Illusion, Prestidigitation)

✂ Special Features
Fey Presence (1 / Short Rest)
Action — Creatures in 10-ft cube make WIS save DC 13
...
🎭 Default Appearance
Small, winged fairy-like humanoid with molten gold eyes.
Often riding on the party bard's shoulder.
True nature detectable by fey or via close inspection.
